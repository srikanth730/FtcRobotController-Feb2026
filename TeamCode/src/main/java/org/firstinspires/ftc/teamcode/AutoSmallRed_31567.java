...
public class AutoSmallRed_31567 extends LinearOpMode {
    ...
    private static final double LAUNCHER_CLOSE_TARGET_VELOCITY = 1450; // ticks/sec 1350 orig
    private static final double LAUNCHER_CLOSE_MIN_VELOCITY    = 1425; //1325 orig
    ...
    public void runOpMode() {
        ...
        driveStraight(DRIVE_SPEED, 46.0, HEADING_RIGHT90_DEG);
