...
@Autonomous(name = "Decode 2026: V2 Blue Goal Auto + Launch", group = "Robot")
public class Decode2026_BlueGoalAuto_Mecanum_V2 extends LinearOpMode {
    ...
    static final double BACKUP_TO_TRIANGLE_APEX_INCHES = 52.0; // TODO: measure & update
